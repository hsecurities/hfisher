...
Version: ${_VERSION}
Architecture: ${_ARCH}
Maintainer: @hsecurities
Depends: ${_depend}
Homepage: https://github.com/hsecurities/hfisher
...
cp -fr .github/ .sites/ LICENSE README.md hfisher.sh ./build_env/$_opt_dir
